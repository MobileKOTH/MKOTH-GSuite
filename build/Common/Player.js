...
(function (PlayerStatus) {
    ...
    PlayerStatus[PlayerStatus["HOLIDAY"] = 1] = "HOLIDAY";
    PlayerStatus[PlayerStatus["REMOVED"] = 2] = "REMOVED";
...
function Player(name) {
    ...
    this.Remove = function () {
        ...
        this.rank = 0;
        for (var row = 1; row < PlayerStatsSheet.getLastRow(); row++) {
...
function GetPlayerList() {
    ...
    try {
        ...
        for (var i = 0; i < playerDB.length; i++) {
            ...
            for (var j = 0; j < playerRankDB.length; j++) {
...
function UpdatePlayerList() {
    var playerlistarr = [];
    for (var uu = 0; uu < PlayerList.length; uu++) {
